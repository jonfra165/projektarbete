...
const Navbar = () => {
    ...
    <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        <a href="index.html" className="d-flex align-items-center mb-2 mb-md-0 text-dark text-decoration-none">
            <svg xmlnsXlink="http://www.w3.org/2000/svg" width="40" height="32" fill="currentColor" className="bi bi-filetype-gif" viewBox="0 0 16 16">
            ...
            <span className="fs-4 fw-bold ms-3">GIF-DAGBOKEN</span>
        </a>
